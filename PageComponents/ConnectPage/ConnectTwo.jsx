          ...
          >
            <div class="connect-thumbnail">
              <div class="left-image">
                <img src="/connect/connect-01.jpg" alt="Nft_Profile" />
              </div>
            </div>
          </div>
          <div class="col-lg-6">
            <div class="row g-5">
              <div
                class="col-xxl-4 col-lg-6 col-md-4 col-12 col-sm-6 col-12"
                data-sal="slide-up"
                data-sal-delay="150"
                data-sal-duration="800"
              >
              ...
              >
                <div class="wallet-wrapper">
                  <div class="inner">
                    <div class="icon">
                      {/* <i class="color-pink" data-feather="award"></i> */}
                    </div>
                    <div class="content">
                      <h4 class="title">
              ...
              >
                <div class="wallet-wrapper">
                  <div class="inner">
                    <div class="icon">
                      {/* <i class="color-yellow" data-feather="briefcase"></i> */}
                    </div>
                    <div class="content">
                      <h4 class="title">
              ...
              >
                <div class="wallet-wrapper">
                  <div class="inner">
                    <div class="icon">
                      {/* <i class="color-green" data-feather="command"></i> */}
                    </div>
                    <div class="content">
                      <h4 class="title">
              ...
              >
                <div class="wallet-wrapper">
                  <div class="inner">
                    <div class="icon">
                      {/* <i class="color-blue" data-feather="cpu"></i> */}
                    </div>
                    <div class="content">
                      <h4 class="title">
